module TetrahedralMeshBenchmarks
...
suite["last_refinement"] = @benchmarkable NewRivaraProductions.refine!(m) setup=(m = create_mesh_and_refine_nsteps(nsteps-1); mark_all_tetrahedra_for_refinement(m)) seconds=nseconds

end

return TetrahedralMeshBenchmarks.suite
